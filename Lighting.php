...
$sql="SELECT * FROM iteam WHERE category='Home and Livings' and type='Lightings';";
			...
			<table border="0" cellspacing="15">
				<tr>
					...
					<td>
						<table border="0">
							<tr>
								<td colspan="5" > <img  src="Home/Lighting/2.JPG" alt="Mountain View" style="width:290px;height:230px;"></td>
							</tr>
							<tr>
					...
					<td>
						<table border="0">
							<tr>
								<td colspan="5" > <img  src="Home/Lighting/3.JPG" alt="Mountain View" style="width:290px;height:230px;"></td>
							</tr>
							<tr>
								<td colspan="5">Lighting</td>
							</tr>
					...
					<td>
						<table border="0">
							<tr>
								<td colspan="5" > <img  src="Home/Lighting/4.jpg" alt="Mountain View" style="width:290px;height:230px;"></td>
							</tr>
							<tr>
								<td colspan="5"> Lighting</td>
							</tr>
