					...
					<td align = 'center'>
						<div class="dropdown" style="float:left;">
						  ...
						  <div class="dropdown-content" style="left:0;">
							<br/>
							<input type="button" value="LOGIN" onclick="window.location.href='login.php'" size="30" style="height:25px; width:100px; color:white;background-color:orange;">
							<input type="hidden" value="LOGOUT" onclick="window.location.href='logout.php'" size="30" style="height:25px; width:100px; color:white;background-color:orange;">
